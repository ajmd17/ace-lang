...
const std::map<ErrorMessage, std::string> CompilerError::error_message_strings {
    ...
    { Msg_generic_expression_must_be_const, "Generic variable '%' must be const" },
    { Msg_generic_expression_no_arguments_provided, "'%' is a generic variable which requires argument(s) provided within <> (may also be empty)" },
    ...
    { Msg_arithmetic_operands_must_be_numbers, "Operands of arithmetic operator '%' must be compatible with 'Number'; got '%' and '%'" },
    { Msg_arithmetic_operand_must_be_numbers, "Operand of arithmetic operator '%' must be compatible with 'Number'; got '%'" },
