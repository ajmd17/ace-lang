...
public:
    ...
    static ObjectType MakeGenericType(const ObjectType &base_type, const std::vector<ObjectType> &param_types);
...
public:
    ...
    */
    ...
    /** Checks if the object type is a generic type */
    inline bool IsGenericType() const { return m_is_generic; }
    ...
    /** Gets the parameter types of this object type (if it is a function or generic) */
